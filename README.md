...
- **A first x64 gameplay loop.** `NEW GAME` enters `LEVEL 01 NEON SPINE`, with WASD movement, a reticle, keyboard fire, optional UEFI pointer left-click fire, a Warden fight, terminal breach, extraction gate, hit counter, and mission-complete state in a pulse-lit pseudo-3D corridor.
