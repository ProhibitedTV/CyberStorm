...
- [assets/sectors.psd1](../assets/sectors.psd1) and [assets/music.psd1](../assets/music.psd1) for gameplay-facing authored content
...
Phase 1 of the asset-bank system also emits a raw map bank:
