...
CyberStorm still uses survival as the primary objective:
...
Winning the full run adds a final survival bonus:

- `25` per remaining shield
- `15` per remaining EMP pulse

This keeps the score system aligned with the original fantasy: breach hard, but keep your runner intact.

## Ranks

End screens turn total score into a simple rank:
...
This pass tries to do three things:
