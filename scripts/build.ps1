...
function Write-X64BootstrapReports {
    ...
    Set-Content -LiteralPath $BuildReportPath -Encoding ascii -Value @(
        ...
        'Gameplay fire: Enter/Space fire through keyboard fallback; UEFI SimplePointer left-click fires when firmware exposes a pointer protocol; active shots draw player-to-reticle beam feedback'
