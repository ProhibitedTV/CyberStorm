...
Write-BuildReport `
    ...
    -Warnings $warnings `
    -ArtifactPaths @($generatedArtPath, $generatedPresentationPath, $generatedSectorContentPath, $generatedMapsPath, $generatedDemosPath, $generatedMusicPath, $replayReportPath, $balanceReportPath, $regressionReportPath, $vmSmokeReportPath, $generatedBankLayoutPath, $mapBankBinPath, $presentationBankBinPath, $bootBinPath, $stage2BinPath, $bootList, $gameList, $bootConfig, $debugConfig, $audioConfig, $imgPath, $vfdPath) + $readmeScreenshotArtifacts + @($reportPath, $screenshotSync.RotationStatePath) + $vmSmokeArtifacts `
    -Layout $layout
