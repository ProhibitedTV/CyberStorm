...
$scenarios = @(
    [pscustomobject]@{ Number = 1; Id = 'splash-to-title'; Name = 'SPLASH TO TITLE'; WaitSeconds = 12 }
    [pscustomobject]@{ Number = 2; Id = 'title-to-start'; Name = 'TITLE TO START'; WaitSeconds = 10 }
    [pscustomobject]@{ Number = 3; Id = 'title-to-attract'; Name = 'TITLE TO ATTRACT'; WaitSeconds = 12 }
)
